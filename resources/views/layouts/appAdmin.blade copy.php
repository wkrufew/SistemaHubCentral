...
<nav style="background-color: black" class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
<div class="mbr-table-cell">
                  <div class="navbar-brand">
                      <a  style="color: white; font-weight: bold" class="navbar-caption">&nbsp; @yield('rol',' Zona Administrador') / {{ $miga }}</a>
                  </div>
              </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
            ...
            <li class="nav-item">
                <a class="nav-link link text-white display-4" href="{{ url('/admin/temas')}}">
                    <span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>Temas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link link text-white display-4" href="{{ url('/admin/articulos')}}">
                    <span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>Artículos</a>
            </li>
            <li class="nav-item">
                <a class="nav-link link text-white display-4" href="{{ url('/admin/usuarios')}}">
                    <span class="mbri-home mbr-iconfont mbr-iconfont-btn"></span>Usuarios</a>
            </li>
